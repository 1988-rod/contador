...
while (continuar){
    ...
    let votacion = prompt("Ley de Protección Ambiental y Desarrollo Sostenible.\nIngrese su voto : \n1- Voto a favor : \n2- Voto con contra : \n    'esc' para terminar votación.")
    //! Depues de varios dias de intentos para hacer funcionar el prompt correctamente,busque la solucion y tuve que entender al null, y la variable true para desp asignarle false y salir del bucle.  
    if (votacion === null ){
        continuar = false
